...
class Callers
  ...
  attr_reader :surname, :name, :date_of_birth, :a_division_of, :salary
  
  def initialize(surname, name, date_of_birth, a_division_of, salary)
    @surname = surname
    @name = name
...
puts ''    
info_1 = Callers.new('Brom', 'Yriu', '10.11.2000', "'152'", 1000)
info_2 = Callers.new('Heroshi', 'Slavik', '18.09.2001', "'134'", 5000)
...
puts ''
puts "Is Heroshi earns more money ?"
s1 = Callers.new('Brom', 'Yriu', '10.11.2000', "'152'", 1000)
s2 = Callers.new('Heroshi', 'Slavik', '18.09.2001', "'134'", 5000)
