...
RESPONSE='{"person":{
              ...
              "additional_info":{
               "hobby":["reading","drinking","swimming"],
               "pets":[{"name":"Chin","species":"cat"},
                       {"name":"Budy","species":"dog"},
                       {"name":"Brauni","species":"cat"},
                       {"name":"Glafiriya","species":"bird"}]}}}'
